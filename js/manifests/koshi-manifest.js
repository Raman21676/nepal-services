...
const KOSHI_MANIFEST = [
    ...
    { path: 'data/provinces/koshi/morang/biratnagar/biratnagar_schools.json', province: 'koshi', district: 'morang', city: 'biratnagar', type: 'schools' },
    { path: 'data/provinces/koshi/morang/biratnagar/biratnagar_pharmacies.json', province: 'koshi', district: 'morang', city: 'biratnagar', type: 'pharmacies' },
    { path: 'data/provinces/koshi/morang/biratnagar/biratnagar_government.json', province: 'koshi', district: 'morang', city: 'biratnagar', type: 'government' },
    { path: 'data/provinces/koshi/morang/biratnagar/biratnagar_hospitals.json', province: 'koshi', district: 'morang', city: 'biratnagar', type: 'hospitals' },
    { path: 'data/provinces/koshi/morang/biratnagar/biratnagar_blood_banks.json', province: 'koshi', district: 'morang', city: 'biratnagar', type: 'banks' },
    { path: 'data/provinces/koshi/morang/biratnagar/biratnagar_ambulance.json', province: 'koshi', district: 'morang', city: 'biratnagar', type: 'ambulance' },
